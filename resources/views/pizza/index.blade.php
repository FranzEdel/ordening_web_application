        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    All Pizza
                    <a href="{{ route('pizza.create') }}" class="btn btn-sm btn-success" style="float: right;">Add pizza</a>
                </div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="{{ Storage::url($pizza->image) }}" title="{{ $pizza->name }}" width="80"></td>
                                <td>{{ $pizza->name }}</td>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal{{ $pizza->id }}">Delete</button>
                                </td>
                                <!-- Modal -->
